...
const JobPostingPreview = ({ formData, setIsPreview }) => {
    ...
    const companyLogoUrl = normalizeImageUrl(user?.companyLogo);
                        ...
                        <div className="relative bg-white px-0 pb-8 mt-8 border-b border-gray-100">
                            <div className="relative z-10">
                                ...
                                <div className="flex flex-wrap gap-3 mt-6 md:mt-0">
                                    ...
                                    <span className="px-4 py-2 bg-blue-50 text-sm text-purple-700 font-semibold rounded-full border border-purple-200">
                                        {JOB_TYPE.find((jt) => jt.value === formData.jobType)?.label}
                                    </span>
