          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl shadow-black/5 border border-white/20 p-6 mb-8">
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <div className="sm:w-48">
                <select
                  className="block w-full px-4 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all duration-200 bg-gray-50/50 text-gray-700"
                  value={statusFilter}
                        ...
                        ? Array.from({length: 5 }).map((_, index) => (
                          ...
                          : paginatedJobs.map((job) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium min-[180px] sm:min-w-0">
                                <div className="flex space-x-2">
                                  <button
                                    className="text-blue-600 hover:text-blue-600 p-2 rounded-lg hover:bg-blue-50 transition-colors duration-200"
