...
const JobPostingForm = () => {
  ...
  const validateForm = (formData) => {
    ...
    if (!formData.salaryMin || !formData.salaryMax) {
      ...
      errors.salaryRange = "Minimum salary must be less than maximum salary";
    }
    return errors;
  };
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white shadow-xl rounded-2xl p-6">
            <div className="flex items-center justify-between mb-8">
              <div>
                <h2 className="text-xl font-bold bg-gradient-to-r from-gray-900 bg-clip-text text-transparent">
                  Post a new Job
                </h2>
            ...
            <div className="space-y-6">
              ...
              <TextAreaField
                ...
                helperText = "Include key responsibilities, day-to-day tasks, and what this role exciting."
                required
                />
              {/* Requirements */}
              <TextAreaField
              ...
              <div className="pt-2">
                ...
                >
                  {isSubmitting ? (
                    <>
                      <div className="animate-spin rounded-full h-5 w-5 border-h-2 border-white mr-2"></div>
                      Publishing Job ...
                    </>
                  ):(
                    <>
